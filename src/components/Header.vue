            ...
            <div :class="{active: isActive}" class="burger-menu">
                <nav class="burger-menu__nav">
                    <ul class="burger-menu__nav-items">
                        <li class="burger-menu__nav-items-item"><a @click="activeBurger" class="burger-menu__nav-items-item-link" href="#about">About me</a></li>
                        <li class="burger-menu__nav-items-item"><a @click="activeBurger" class="burger-menu__nav-items-item-link" href="#skills">Skills</a></li>
                        <li class="burger-menu__nav-items-item"><a @click="activeBurger" class="burger-menu__nav-items-item-link" href="#projects">Project</a></li>
                        <li class="burger-menu__nav-items-item"><a @click="activeBurger" class="burger-menu__nav-items-item-link" href="#contact">Contact me</a></li>
                    </ul>
                </nav>
                <a href="../assets/resume.pdf" download class="burger-menu__button">Resume 
                    <svg class="burger-menu__button-img" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M17.5 12.5V13.5C17.5 14.9001 17.5 15.6002 17.2275 16.135C16.9878 16.6054 16.6054 16.9878 16.135 17.2275C15.6002 17.5 14.9001 17.5 13.5 17.5H6.5C5.09987 17.5 4.3998 17.5 3.86502 17.2275C3.39462 16.9878 3.01217 16.6054 2.77248 16.135C2.5 15.6002 2.5 14.9001 2.5 13.5V12.5M14.1667 8.33333L10 12.5M10 12.5L5.83333 8.33333M10 12.5V2.5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
            </div>
        </div>
...
<style lang="scss" scoped>
    .burger{
        ...
        &-menu{
            ...
            opacity: 0;
            max-height: 0;
            transition: opacity 0.5s ease, max-height 0.5s ease, visibility 0s 0.5s;
            overflow: hidden;
            position: absolute;
            top: 75%;
            left: 0;
            ...
            &.active{
                @media (max-width: 767px) {
                    ...
                    transition: opacity 0.5s ease, max-height 0.5s ease, visibility 0s 0s;
    ...
    .burger.active{
        .line-up{
            transform: translateY(calc(0.72rem - 1px)) rotate(45deg);
        }
        ...
        .line-down{
            transform: translateY(calc(-0.55rem + 1px)) rotate(-45deg);
        }
    }
